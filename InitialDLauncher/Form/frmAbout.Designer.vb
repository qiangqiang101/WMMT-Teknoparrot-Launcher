...
Partial Class frmAbout
    ...
    Private Sub InitializeComponent()
        ...
        Dim NsListViewColumnHeader2 As WMMTLauncher.NSListView.NSListViewColumnHeader = New WMMTLauncher.NSListView.NSListViewColumnHeader()
        Dim NsListViewColumnHeader3 As WMMTLauncher.NSListView.NSListViewColumnHeader = New WMMTLauncher.NSListView.NSListViewColumnHeader()
        Dim NsListViewColumnHeader4 As WMMTLauncher.NSListView.NSListViewColumnHeader = New WMMTLauncher.NSListView.NSListViewColumnHeader()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmAbout))
        Me.NsTheme1 = New WMMTLauncher.NSTheme()
        Me.wbAbout = New WMMTLauncher.MyWebBrowser()
        Me.NsGroupBox1 = New WMMTLauncher.NSGroupBox()
        Me.lvPlugins = New WMMTLauncher.NSListView()
        Me.btnDonate = New WMMTLauncher.NSButton()
        ...
        Me.lvPlugins.Columns = New WMMTLauncher.NSListView.NSListViewColumnHeader() {NsListViewColumnHeader1, NsListViewColumnHeader2, NsListViewColumnHeader3, NsListViewColumnHeader4}
        Me.lvPlugins.Items = New WMMTLauncher.NSListView.NSListViewItem(-1) {}
